...
//search
  ...
  setData([...SearchData.data.Search.filter((el)=>{
...
//sort
  ...
  return (
    ...
    <Helmet>
                ...
                <link rel="canonical" href="http://myfilms.com/HarryPotter" />
            </Helmet>
...
<button onClick={()=>{RepeadSort()}}>Repead Sort</button>
    ...
    {data?.map((element) => {
        return (
          <Link key={element.imdbID} to={`/${element.imdbID}`}  style={{  maxWidth:"1300px",margin:"0 auto" }}>
